...
% how will ANNs deal with class imbalance compared to Zero-Shot Models? maybe talk below? leaving this here so we don't forget to mention it
...
\noindent Supporting modules include \texttt{metrics.py}, which provides functions for computing evaluation metrics such as accuracy and F1-score, and \texttt{logs.py}, which handles experiment logging for ease of access to the results after it is conducted.
